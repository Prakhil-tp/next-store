<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMainPage.Master" AutoEventWireup="true" CodeBehind="Productdetails.aspx.cs" Inherits="ShoppingCart.UI.Admin.Productdetails" %>
                    ...
                    <table class="style1">
                        ...
                        <tr>
                            ...
                            <td>
                                &nbsp;</td>
                            <td>
                                <asp:LinkButton ID="LinkButtonEdit" runat="server" ForeColor="#0066CC" 
            ...
            <table border="0" height="127" 
                ...
                <tr>
                    <td>
                        &nbsp;</td>
                    <td align="right">
                        <asp:LinkButton ID="RemoveComments" runat="server" 
                            CommandArgument='<%# Eval("ReviewId") %>' CommandName="Remove" 
                            ForeColor="#0066CC">Remove</asp:LinkButton>
                    </td>
                </tr>
            </table>
...
<br />
    ...
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
        ...
        SelectCommand="SELECT Review.ProductId, Product.ProductName, Product.ProductId AS Expr1, Review.Comments, RegisteredUser.Name, RegisteredUser.UserId, Review.ReviewId FROM Review INNER JOIN RegisteredUser ON Review.UserId = RegisteredUser.UserId INNER JOIN Product ON Review.ProductId = Product.ProductId WHERE (Product.ProductId = @productId)">
        <SelectParameters>
            <asp:ControlParameter ControlID="HiddenFieldProductId" Name="productId" 
                PropertyName="Value" />
        </SelectParameters>
